...
# get the IPC of the two-level cache
IPC_2MM_PPF = get_IPC('m5out-2MM-PPF/stats.txt')
IPC_2MM_SPPV2 = get_IPC('m5out-2MM-SPPV2/stats.txt')
IPC_BFS_PPF = get_IPC('m5out-BFS-PPF/stats.txt')
IPC_BFS_SPPV2 = get_IPC('m5out-BFS-SPPV2/stats.txt')
IPC_bzip2_PPF = get_IPC('m5out-bzip2-PPF/stats.txt')
IPC_bzip2_SPPV2 = get_IPC('m5out-bzip2-SPPV2/stats.txt')
IPC_mcf_PPF = get_IPC('m5out-mcf-PPF/stats.txt')
IPC_mcf_SPPV2 = get_IPC('m5out-mcf-SPPV2/stats.txt')

# get the hit rate of the two-level cache
hit_rate_2MM_PPF = get_hit_rate('m5out-2MM-PPF/stats.txt')
hit_rate_2MM_SPPV2 = get_hit_rate('m5out-2MM-SPPV2/stats.txt')
hit_rate_BFS_PPF = get_hit_rate('m5out-BFS-PPF/stats.txt')
hit_rate_BFS_SPPV2 = get_hit_rate('m5out-BFS-SPPV2/stats.txt')
hit_rate_bzip2_PPF = get_hit_rate('m5out-bzip2-PPF/stats.txt')
hit_rate_bzip2_SPPV2 = get_hit_rate('m5out-bzip2-SPPV2/stats.txt')
hit_rate_mcf_PPF = get_hit_rate('m5out-mcf-PPF/stats.txt')
hit_rate_mcf_SPPV2 = get_hit_rate('m5out-mcf-SPPV2/stats.txt')

# get the accuracy of the prefetcher
accuracy_2MM_PPF = get_accuracy('m5out-2MM-PPF/stats.txt')
accuracy_2MM_SPPV2 = get_accuracy('m5out-2MM-SPPV2/stats.txt')
accuracy_BFS_PPF = get_accuracy('m5out-BFS-PPF/stats.txt')
accuracy_BFS_SPPV2 = get_accuracy('m5out-BFS-SPPV2/stats.txt')
accuracy_bzip2_PPF = get_accuracy('m5out-bzip2-PPF/stats.txt')
accuracy_bzip2_SPPV2 = get_accuracy('m5out-bzip2-SPPV2/stats.txt')
accuracy_mcf_PPF = get_accuracy('m5out-mcf-PPF/stats.txt')
accuracy_mcf_SPPV2 = get_accuracy('m5out-mcf-SPPV2/stats.txt')

# get the coverage of the prefetcher
coverage_2MM_PPF = get_coverage('m5out-2MM-PPF/stats.txt')
coverage_2MM_SPPV2 = get_coverage('m5out-2MM-SPPV2/stats.txt')
coverage_BFS_PPF = get_coverage('m5out-BFS-PPF/stats.txt')
coverage_BFS_SPPV2 = get_coverage('m5out-BFS-SPPV2/stats.txt')
coverage_bzip2_PPF = get_coverage('m5out-bzip2-PPF/stats.txt')
coverage_bzip2_SPPV2 = get_coverage('m5out-bzip2-SPPV2/stats.txt')
coverage_mcf_PPF = get_coverage('m5out-mcf-PPF/stats.txt')
coverage_mcf_SPPV2 = get_coverage('m5out-mcf-SPPV2/stats.txt')
